...
- **Materials** (`game/resources/materials/`, `tools/textures/generate_textures.py`): seamless PBR textures
  (castle wall, flagstone, cut stone, old wood, dark iron), applied with world space triplanar mapping.
...
docs/             Design notes
tools/textures/   Seamless PBR texture generator (python + numpy + pillow)
```
